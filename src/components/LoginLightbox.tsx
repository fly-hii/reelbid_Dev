...
import { Loader2, Mail, Lock, Film, ShieldCheck, KeyRound, Send, X } from 'lucide-react';
...
export default function LoginLightbox({ isOpen, onClose, onSuccess }: LoginLightboxProps) {
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            ...
            if (signInRes?.error) {
                toast.error('Signin failed after verification');
            } else {
    ...
    const handleGoogleLogin = () => {
        // For Google, it must redirect, but we can set callbackUrl to current page
            ...
            >
                ...
                <div style={{ textAlign: 'center', marginBottom: '28px' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '6px' }}>
                        Join the auction directly from this page
                    </p>
                </div>
                ...
                <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                    ...
                    <Link href="/auth/register" onClick={onClose} style={{ color: 'var(--accent-text)', fontWeight: 700, textDecoration: 'none' }}>
                        Register as Buyer
                    </Link>
                </p>
            </div>
